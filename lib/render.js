...
const DEFAULT_TITLE = 'CineBox · Онлайн Филми и Сериали';
const DEFAULT_DESC = 'Гледайте актуални филми и сериали онлайн с български субтитри.';
...
function posterCard(item, tab = 'movie') {
  ...
  // Menggunakan slugify dengan fallback yang aman ('details') agar tidak menghasilkan URL kosong/error 404
...
// Helper lokal untuk slugify di dalam render jika dibutuhkan
...
// Fungsi img lokal untuk pemanggilan di render helper jika diperlukan
