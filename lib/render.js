...
<body>
  ...
  <footer id="footer">
    <div class="footer-inner">
      ...
      <!-- Histats Counter Code Hidden START -->
      ...
      <!-- Histats Counter Code Hidden END -->
    </div>
  </footer>
...
function nativeBannerAd() {
  return `
    <div class="ad-container" style="text-align: center; margin: 20px 0;">
      <script async="async" data-cfasync="false" src="//pl25946894.profitablegatenc.com/YOUR_NATIVE_KEY/invoke.js"></script>
